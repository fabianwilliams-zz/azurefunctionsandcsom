...
public static class csomHelper {
    ...
    private static string ClientId = "obs-ured-for-demo-dc82469b62f7";
    private static string Cert = "FabianWilliamsPrivateCert.pfx";                      // Fill in name of your cert file and upload it
    private static string CertPassword = "REDACATED"; // TODO: Explore more secure place for this
    ...
    public async static Task<ClientContext> GetClientContext(string siteUrl)
    {
        ...
        var certPath = Path.Combine(Environment.GetEnvironmentVariable("HOME"), "site\\wwwroot\\shared\\", Cert);
